...
?>
 <div class="titulo">
  ...
  <div class="formulario">
    ...
    <br>
    <input type="number" name="cpf" value= "<?php echo $cpf?>" required maxlenght="11">
    <br>
    <br>
    ...
    <br>
    <input type="number" name="idade" value=<?php echo $idade ?>required max="100">
    <br>
    <br>
    ...
    <br>
    <br>
    <label for="estatus">Ativo:</label>
    <br>
    <select name="estatus" id="estatus"  value=<?php echo $estatus ?>required>
